...
export default function loading() {
  return (
    <div className="fixed inset-0 backdrop-blur-md flex justify-center items-center w-full h-full ">
      <div className="w-[400px] h-auto bg-white rounded-2xl flex justify-center items-center p-[3rem] shadow-sm flex-col gap-4">
        ...
        <div className='text-center text-2xl font-semi-bold text-black'>Processing your request...</div>
      </div>
    </div>
  )
}
