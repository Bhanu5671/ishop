...
export default async function page({ params, searchParams }) {
    ...
    const productJSON = await getProductData(null, true, category_slug, searchParams.sortByName ?? null, searchParams.sortByPrice ?? null, searchParams.sortByDate ?? null, searchParams.show ?? null, searchParams.color ?? null, searchParams.min ?? null, searchParams.max ?? null);
